...
In the next diagram you can see my homelab's architecture.

![Architecture](https://github.com/Pelochus/pelochus-homelab/blob/main/img/pelochus-homelab.drawio.png)
